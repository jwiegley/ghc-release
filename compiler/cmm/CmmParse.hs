...
{-# INLINE happyOut30 #-}
happyIn31 :: ([ExtFCode CmmActual]) -> (HappyAbsSyn )
happyIn31 x = unsafeCoerce# x
{-# INLINE happyIn31 #-}
happyOut31 :: (HappyAbsSyn ) -> ([ExtFCode CmmActual])
happyOut31 x = unsafeCoerce# x
{-# INLINE happyOut31 #-}
happyIn32 :: ([ExtFCode CmmActual]) -> (HappyAbsSyn )
happyIn32 x = unsafeCoerce# x
{-# INLINE happyIn32 #-}
happyOut32 :: (HappyAbsSyn ) -> ([ExtFCode CmmActual])
happyOut32 x = unsafeCoerce# x
{-# INLINE happyOut32 #-}
happyIn33 :: ([ExtFCode CmmActual]) -> (HappyAbsSyn )
happyIn33 x = unsafeCoerce# x
{-# INLINE happyIn33 #-}
happyOut33 :: (HappyAbsSyn ) -> ([ExtFCode CmmActual])
happyOut33 x = unsafeCoerce# x
{-# INLINE happyOut33 #-}
happyIn34 :: (ExtFCode CmmActual) -> (HappyAbsSyn )
happyIn34 x = unsafeCoerce# x
{-# INLINE happyIn34 #-}
happyOut34 :: (HappyAbsSyn ) -> (ExtFCode CmmActual)
...
{-# INLINE happyOut37 #-}
happyIn38 :: ([ExtFCode CmmFormal]) -> (HappyAbsSyn )
happyIn38 x = unsafeCoerce# x
{-# INLINE happyIn38 #-}
happyOut38 :: (HappyAbsSyn ) -> ([ExtFCode CmmFormal])
happyOut38 x = unsafeCoerce# x
{-# INLINE happyOut38 #-}
happyIn39 :: ([ExtFCode CmmFormal]) -> (HappyAbsSyn )
happyIn39 x = unsafeCoerce# x
{-# INLINE happyIn39 #-}
happyOut39 :: (HappyAbsSyn ) -> ([ExtFCode CmmFormal])
happyOut39 x = unsafeCoerce# x
{-# INLINE happyOut39 #-}
happyIn40 :: (ExtFCode CmmFormal) -> (HappyAbsSyn )
happyIn40 x = unsafeCoerce# x
{-# INLINE happyIn40 #-}
happyOut40 :: (HappyAbsSyn ) -> (ExtFCode CmmFormal)
	...
	happyIn8
		 (do lits <- sequence happy_var_4;
		     return $ map CmmStaticLit $
                       mkStaticClosure (mkForeignLabel happy_var_3 Nothing True IsData)
...
happyReduction_112 happy_x_1
	 =  case happyOut28 happy_x_1 of { happy_var_1 -> 
	happyIn34
		 (do e <- happy_var_1; return (CmmKinded e (inferCmmKind e))
	)}
...
happyReduction_113 (happy_x_2 `HappyStk`
	...
	case happyOutTok happy_x_2 of { (L _ (CmmT_String	happy_var_2)) -> 
	( do h <- parseCmmKind happy_var_2;
					      return $ do
						e <- happy_var_1; return (CmmKinded e h))}}
...
happyReduction_125 happy_x_1
	...
	happyIn40
		 (do e <- happy_var_1; return (CmmKinded e (inferCmmKind (CmmReg (CmmLocal e))))
	)}
...
happyReduction_126 (happy_x_2 `HappyStk`
	...
	( do h <- parseCmmKind happy_var_1;
					      return $ do
						e <- happy_var_2; return (CmmKinded e h))}}
