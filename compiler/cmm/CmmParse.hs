...
happyReduction_7 (happy_x_6 `HappyStk`
	...
	happyIn6
		 (do lbl <- happy_var_4;
		     ...
		     code (emitData (section happy_var_2) (Statics lbl $ concat ss))
	) `HappyStk` happyRest}}}
...
happyReduction_22 (happy_x_14 `HappyStk`
	...
	( withThisPackage $ \pkg ->
		   do prof <- profilingInfo happy_var_11 happy_var_13
			...
			CmmInfoTable (mkCmmInfoLabel pkg happy_var_3) False prof (fromIntegral happy_var_9)
...
happyReduce_24 = happyMonadReduce 18# 8# happyReduction_24
happyReduction_24 (happy_x_18 `HappyStk`
	happy_x_17 `HappyStk`
	happy_x_16 `HappyStk`
	happy_x_15 `HappyStk`
	happy_x_14 `HappyStk`
...
happyReduce_25 = happyMonadReduce 16# 8# happyReduction_25
...
happyReduce_26 = happyMonadReduce 12# 8# happyReduction_26
happyReduction_26 (happy_x_12 `HappyStk`
	...
	( withThisPackage $ \pkg ->
		   do prof <- profilingInfo happy_var_9 happy_var_11
		      return (mkCmmEntryLabel pkg happy_var_3,
			CmmInfoTable (mkCmmInfoLabel pkg happy_var_3) False prof (fromIntegral happy_var_7)
				     (ThunkSelectorInfo (fromIntegral happy_var_5) NoC_SRT),
			[]))}}}}}
	) (\r -> happyReturn (happyIn12 r))

happyReduce_27 = happyMonadReduce 6# 8# happyReduction_27
happyReduction_27 (happy_x_6 `HappyStk`
	...
	( withThisPackage $ \pkg ->
		   do let infoLabel = mkCmmInfoLabel pkg happy_var_3
			...
			CmmInfoTable (mkCmmInfoLabel pkg happy_var_3) False (ProfilingInfo zeroCLit zeroCLit) (fromIntegral happy_var_5)
				     (ContInfo [] NoC_SRT),
			[]))}}
	) (\r -> happyReturn (happyIn12 r))

happyReduce_28 = happyMonadReduce 8# 8# happyReduction_28
...
happyReduce_45 = happyMonadReduce 11# 14# happyReduction_45
...
happyReduce_46 = happyMonadReduce 10# 14# happyReduction_46
...
happyReduce_47 = happyMonadReduce 5# 14# happyReduction_47
...
happyReduce_63 = happyMonadReduce 1# 18# happyReduction_63
...
happyReduce_100 = happyMonadReduce 5# 28# happyReduction_100
...
happyReduce_106 = happyReduce 4# 29# happyReduction_106
...
happyReduce_107 = happyMonadReduce 5# 29# happyReduction_107
...
happyReduce_118 = happyMonadReduce 2# 34# happyReduction_118
happyReduction_118 (happy_x_2 `HappyStk`
	happy_x_1 `HappyStk`
	happyRest) tk
...
happyReduce_119 = happySpecReduce_0  35# happyReduction_119
happyReduction_119  =  happyIn39
		 ([]
	)
...
happyReduction_125  =  happyIn42
		 ([]
	)

happyReduce_126 = happyReduce 4# 38# happyReduction_126
...
happyReduce_131 = happyMonadReduce 2# 40# happyReduction_131
...
happyReduce_139 = happySpecReduce_2  45# happyReduction_139
...
happyReduction_143  =  happyIn51
		 (return Nothing
	)

happyReduce_144 = happyReduce 5# 47# happyReduction_144
...
happyReduce_145 = happySpecReduce_0  48# happyReduction_145
happyReduction_145  =  happyIn52
		 (return Nothing
	)
