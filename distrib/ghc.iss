...
[Setup]
AppName=GHC
AppVerName=GHC 7.0.2
DefaultDirName={sd}\ghc\ghc-7.0.2
...
[Files]
Source: "bindistprep\ghc-7.0.2\*"; DestDir: "{app}"; Flags: recursesubdirs
Source: "distrib\windows-installer-licences.txt"; DestDir: "{app}\doc"
Source: "distrib\hsicon.ico"; DestDir: "{app}\icons"

; Start Menu shortcuts
[Icons]
Name: "{group}\7.0.2\GHCi"; Filename: "{app}\bin\ghci.exe"; WorkingDir: "{app}\bin"
Name: "{group}\7.0.2\GHC Documentation"; Filename: "{app}\doc\html\index.html"
Name: "{group}\7.0.2\GHC Library Documentation"; Filename: "{app}\doc\html\libraries\index.html"
Name: "{group}\7.0.2\GHC Flag Reference"; Filename: "{app}\doc\html\users_guide\flag-reference.html"
...
Root: HKCR; Subkey: "ghc_haskell\shell\Open with GHCi 7.0.2"; ValueType: none; ValueName: ""; ValueData: ""; Flags: uninsdeletekey; Tasks: fileassoc\addon
Root: HKCR; Subkey: "ghc_haskell\shell\Open with GHCi 7.0.2\command"; ValueType: string; ValueName: ""; ValueData: """{app}\bin\ghci.exe"" ""%1"""; Flags: uninsdeletevalue; Tasks: fileassoc\addon
...
Root: HKCU; Subkey: "Software\Haskell\GHC\ghc-7.0.2"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
